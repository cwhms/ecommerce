...
<html lang="en">
  <head>
    ...
    <style>
      ...
      body{
        background: url('images/stars-in-the-sky-wallpaper-11.jpg') no-repeat;
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      ?>
        <li><a class="navbar-brand" href="cart.php"><img style="max-width:25px;max-height:25px;" src="images/giohang.png" alt="Brand"></img>
